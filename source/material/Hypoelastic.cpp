...
void Hypoelastic::updateStressForBbarElement(ObjectElementData & element_data)
{
    ...
    for (int i = 0; i < num_node; i++)
    {
        ...
        for (int ii = 0; ii < 3; ii++)
        {
            for (int jj = 0; jj < 3; jj++)
            {
                centroid_dNI_dxm[jj] += centroid_dNI_dX[ii] * centroid_dxm_dX_inv[ii][jj];
            }
        }
        for (int ii = 0; ii < 3; ii++)
        {
    ...
    for (int i = 0; i < num_GP; i++) // 循环积分点
    {
        ...
        for (int ii = 0; ii < num_node; ii++)
        {
            ...
            for (int jj = 0; jj < 3; jj++)
            {
                for (int kk = 0; kk < 3; kk++)
                {
                    dNK_dxm[kk] += dNK_dX[jj] * dxm_dX_inv[jj][kk];
                }
            }
...
void Hypoelastic::getDSDuForBbarElement(ObjectElementData & element_data, std::vector<std::vector<double>> & dS_du)
{
    ...
    for (int i = 0; i < num_node; i++)
    {
        ...
        for (int ii = 0; ii < 3; ii++)
        {
            for (int jj = 0; jj < 3; jj++)
            {
                centroid_dNIs_dxm[i][jj] += centroid_dNI_dX[ii] * centroid_dxm_dX_inv[ii][jj];
            }
        }
    }
        ...
        for (int K = 0; K < num_node; K++)
        {
            ...
            for (int J = 0; J < num_node; J++)
            {
                ...
                for (int ii = 0; ii < 3; ii++)
                {
                    for (int jj = 0; jj < 3; jj++)
                    {
                        dNJ_dxm[jj] += dNJ_dX[ii] * dxm_dX_inv[ii][jj];
                    }
                }
