...
void Hypoelastic::updateStressForBbarElement(ObjectElementData & element_data)
{
    int num_GP = element_data.num_integration_points;
    int num_node = element_data.num_nodes;
    double delt[3][3] = {0.0};
...
void Hypoelastic::getDSDuForBbarElement(ObjectElementData & element_data, std::vector<std::vector<double>> & dS_du)
{
    double delt[3][3] = {0.0};
    for (int ii = 0; ii < 3; ii++) delt[ii][ii] = 1.0;
    int num_GP = element_data.num_integration_points;
...
void Hypoelastic::updateStressAndDSDu(ObjectElementData &element_data, std::vector<std::vector<double>> &dS_du) 
{
    int num_GP = element_data.num_integration_points;
    int num_node = element_data.num_nodes;
    int size = num_GP * num_node;
...
void Hypoelastic::updateStressAndDSDuForBbarElement(ObjectElementData &element_data, std::vector<std::vector<double>> &dS_du) 
{
    double delt[3][3] = {0.0};
    for (int ii = 0; ii < 3; ii++) delt[ii][ii] = 1.0;
    int num_GP = element_data.num_integration_points;
...
void Hypoelastic::getQetc(ObjectElementData & element_data, const int ip_num, 
                          double du_dX[3][3],
                          double Fm[3][3],
                          double Fm_inv[3][3],
                          double Im[3][3], 
...
void Hypoelastic::getDQetc(ObjectElementData & element_data, const int ip_num, const int node_num,
...
void Hypoelastic::preBbar(ObjectElementData & element_data,
                          double & e_dil_Bbar,
                          double Fm_Bbar[3][3],
...
void Hypoelastic::get_centroid_de_du(ObjectElementData &element_data,
...
void Hypoelastic::get_e_dil(ObjectElementData & element_data,
                            const int ip_num,
                            const double Fm_inv[3][3],
                            double & e_dil)
{
...
void Hypoelastic::update_ddm_du_K_ForBbarElement(ObjectElementData & element_data,
                                                 const int ip_num,
                                                 const int node_num,
                                                 const double Fm_inv[3][3],
