...
void NonLinearHex8NewBbar::initializeElement(ObjectElementData & element_data)
{
...
void NonLinearHex8NewBbar::ComputeStiffness(ObjectElementData &element_data,
...
void NonLinearHex8NewBbar::getShapeFunction(double nodes_coordinate[20][3],
...
void NonLinearHex8NewBbar::SetElement()
{
    // 设置维度
    dim = 3;
    // 设置节点自由度数
...
void NonLinearHex8NewBbar::initialize_element(double nodes_coordinate[20][3],
                                       std::vector<std::vector<double>> &GaussPoints,
                                       vector<vector<double>> &ShapeFunction,
                                       vector<vector<vector<double>>> &ShapeFunction_dxy,
                                       vector<double> &value_jkb,
...
void NonLinearHex8NewBbar::updateF_Finv(ObjectElementData &elementdata)
{
    double ux = 0.0;
    double uy = 0.0;
    double uz = 0.0;  
...
void NonLinearHex8NewBbar::ComputeInternalForce(ObjectElementData &element_data,
...
void NonLinearHex8NewBbar::updateInternalVariable(ObjectElementData & elementdata)
{
